...
class Action extends React.Component {
    ...
    render (){
            ...
            const moviesHandle = allMoviesContent.filter((element,i)=>(element.Category==='action')).map((item, key) => {
...
export default connect("listMovies, isLoading",actions)(withRouter(Action));
