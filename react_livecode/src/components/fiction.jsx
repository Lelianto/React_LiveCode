...
class Fiction extends React.Component {
    ...
    render (){
            ...
            // Menampilkan Movie dengan genre Fiction
            const moviesHandle = allMoviesContent.filter((element,i)=>(element.Category==='fiction')).map((item, key) => {
...
export default connect("listMovies, isLoading",actions)(withRouter(Fiction));
