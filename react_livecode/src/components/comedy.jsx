...
class Comedy extends React.Component {
    ...
    render (){
            ...
            // Menampilkan Movie dengan genre Comedy
            const moviesHandle = allMoviesContent.filter((element,i)=>(element.Category==='comedy')).map((item, key) => {
...
export default connect("listMovies, isLoading",actions)(withRouter(Comedy));
